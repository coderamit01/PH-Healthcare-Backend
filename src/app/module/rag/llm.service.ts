...
export class LLMService {
  ...
  constructor() {
    ...
    this.model = envVars.RAG.LLM_MODEL || envVars.RAG.EMBEDDING_MODEL || "nvidia/nemotron-3-super-120b-a12b:free";
  ...
  async generateResponse(prompt: string, context: string[] = [], asJson: boolean = false) {
    try {
